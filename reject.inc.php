<?php
  ...
  $database = DBopen();
  pageheader("VT Event Calendar, Event Update Rejection",
             "Reject Update",
   	         "","",$database);
  echo "<BR>";
  box_begin("inputbox","Reject event update");
...
<FORM method="post" action="approval.php">
  Reason for rejecting this update (send as a notification to the sponsor):
  <BR>
